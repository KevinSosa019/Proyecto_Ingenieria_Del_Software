...
VALUES
('Kevin', NULL, 'Rivera', NULL, 'kereadmin@hotmail.es', 'pokemon1', 1, '0000-0001', 1, NULL, GETDATE(), NULL),
('Kevin', NULL, 'Rivera', NULL, 'kereclient@hotmail.es', 'pokemon1', 2, '0000-0002', 1, NULL, GETDATE(), NULL),
('Kevin', NULL, 'Rivera', NULL, 'keretechnician@hotmail.es', 'pokemon1', 3, '0000-0003', 1, NULL, GETDATE(), NULL);
GO
...
(codigo, maquina_id, tipo_id, prioridad_id, estado_id, descripcion, tecnico_id, usuario_creador_id, fecha_creacion, fecha_asignacion)
VALUES
('OT-0001', 1, 6, 3, 1, 'La máquina no acepta monedas.', 1, 2, GETDATE(), DATEADD(hour,-2, GETDATE())),
('OT-0002', 2, 4, 2, 2, 'Pantalla parpadea cada 5 minutos.', 1, 2, GETDATE(), DATEADD(minute,-45, GETDATE())),
('OT-0003', 3, 3, 1, 1, 'Software congelado al iniciar.', 1, 2, GETDATE(), GETDATE());
